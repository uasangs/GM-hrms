            ...
            >
              ...
              {openDropdown === "onboarding" && (
                <ul className="submenu">
                  ...
                  <NavLink to="/dashboard/onboarding/Candidateportal" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>Candidateportal</li>
                  </NavLink>
                  <NavLink to="/dashboard/onboarding/hr-initiation" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>HR Initiation</li>
                  </NavLink>
                  <NavLink to="/dashboard/onboarding/offer-letters" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>Offer Letters</li>
                  </NavLink>
                  <NavLink to="/dashboard/onboarding/pre-joining" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>Pre-Joining</li>
                  ...
                  <NavLink to="/dashboard/onboarding/asset-management" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>Asset Management</li>
                  </NavLink>
                  <NavLink to="/dashboard/onboarding/enhanced" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>Enhanced Analytics</li>
                  </NavLink>
                  <NavLink to="/dashboard/onboarding/probation" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
                    <li>Probation</li>
                  </NavLink>
                  <NavLink to="/dashboard/onboarding/manager-review" className={({ isActive }) => (isActive ? "active" : "")} onClick={closeSidebar}>
